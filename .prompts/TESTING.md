...
To illustrate the principles above, consider the following simple function:
...
If the user provides a function and existing tests: Provide a critical review of the tests. Identify weaknesses, antipatterns, and areas for improvement based on the principles above. Suggest specific changes with code examples.
